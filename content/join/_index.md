+++
title = 'Join DS@GT ARC'
linkTitle = 'Join'
description = 'Find the best path into DS@GT ARC through current cycle status, archived recruitment pages, FAQ, and contact information.'
menu = 'main'
weight = 2
+++
...
- **Who can join:** Georgia Tech students across programs, including online students. Alumni with continuing student status may also participate.
- **Baseline expectations:** join DS@GT, pay dues, and contribute consistently across the semester.
- **Technical background:** Python, Git, and prior project-based experience are strongly recommended.
