+++
title = 'Fall 2025 Interest Group Archive'
description = 'Archived information about the DS@GT ARC Fall 2025 interest group and how ARC prepared members for the Spring 2026 competition cycle.'
aliases = ['/fall_recruitment/']
weight = 10
+++

# Fall 2025 Interest Group Archive

This page is preserved as an archive of the Fall 2025 onboarding cycle. If you are new to ARC now, use the [Join page](/join/) for the current status and expected Fall 2026 entry path.

- **Cycle status:** completed
- **Original sign-up form:** [Interest Group Sign up Form](https://docs.google.com/forms/d/e/1FAIpQLSfODo9AxoE0exzTFT2115nYWbYw4dWfDK3jvnDvKoKH-3LkbA/viewform?usp=dialog)
...
If you are deciding whether ARC is a good fit, you may also want to read our [Join page](/join/), [FAQ](/faq/), and [history](/history/).

The remaining content on this page reflects the information shared during Fall 2025.
...
## Interest Group Format (Archived)
